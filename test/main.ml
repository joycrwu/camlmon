...
let character_tests =
  [
    ...
    get_atk_test "Dinoplant's attack" dinoplant 50;
    get_affinity_test "Larry's attack" larry "Cascadilla Hall";
    get_affinity_test "Dinoplant's attack" dinoplant "Cascadilla Hall";
    ...
    get_partner_test "Larry partner" larry "Dinoplant";
    get_partner_test "Dinoplant partner" dinoplant "Larry";
    get_partner_eff_test "Larry partner" larry 2;
    get_partner_eff_test "Dinoplant partner" dinoplant 2;
    ...
    get_rarity_test "Larry rarity" larry 20;
    get_rarity_test "Dinoplant rarity" dinoplant 20;
  ]
